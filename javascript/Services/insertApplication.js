...
async function insertApplication(applicationData) {
    ...
    const result = await db.pool.query(insertQuery, [applicationData.teacherId, applicationData.schoolCode, applicationData.paymentMethod, applicationData.invoiceNeeded, applicationData.comments, 0, applicationData.privacyPolicy]);
